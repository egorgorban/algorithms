...
# элементы словаря [v, t1, t2, av_t], где v - значение переменной, характеризующей объём входных данных (количество вершин), 
# t1, t2 - время работы алгоритма на текущем и удвоенном объёме данных соответственно, 
...
a1 = [meas[i][1]/meas[i][2] for i in range(len(meas))]
a2 = np.array(meas)[:,3]/4
